...
const ReportePagos = ({ reportesCEBA }) => {

    const bgChart = useColorModeValue('white', '#1e1e1e');

    var pagosCEBA = [];

    if (reportesCEBA?.pagos) {
        pagosCEBA = reportesCEBA?.pagos[0];
    }
    ...
    const BarOptions = {
        ...
        series: [
            {
                name: 'AÑO ACTUAL',
                data: [pagosCEBA?.cantidad_pagos_por_anio],
                color: '#3498db'
            },
            {
                name: 'ESTE MES',
                data: [pagosCEBA?.cantidad_pagos_por_mes],
                color: '#2ecc71'
            },
            {
                name: 'TOTAL DE REGISTROS',
                data: [pagosCEBA?.total_registro_pagos],
                color: '#4a5568'
            },
        ],
        exporting: {
        ...
        series: [
            {
                ...
                data: [pagosCEBA?.monto_total_pagos_por_anio],
                color: '#154360'
            },
            {
                name: 'MONTO TOTAL GENERAL',
                data: [pagosCEBA?.monto_total_pagos],
                color: '#5dade2'
            }
        ],
        exporting: {
            ...
            data: [
                {
                    ...
                    y: pagosCEBA?.pagos_cancelados,
                    color: '#38a169'
                },
                {
                    name: 'PAGOS PENDIENTES',
                    y: pagosCEBA?.pagos_pendientes,
                    color: '#e53e3e'
                },
                {
                    name: 'PAGOS INCOMPLETOS',
                    y: pagosCEBA?.pagos_incompletos,
                    color: '#f1c40f'
                }
            ]
        }],
    ...
    const Barras = {
        ...
        series: [
            {
                name: 'EFECTIVO',
                data: [pagosCEBA?.pagos_efectivo],
                color: '#e53e3e'
            },
            {
                name: 'TARJETA DE CRÉDITO',
                data: [pagosCEBA?.pagos_tarjeta],
                color: '#3498db'
            },
            {
                name: 'TRANSFERENCIA BANCARIA',
                data: [pagosCEBA?.pagos_transferencia],
                color: '#34495e'
            },
            {
                name: 'YAPE',
                data: [pagosCEBA?.pagos_yape],
                color: '#7d3c98'
            },
            {
                name: 'DEPOSITO BANCARIO',
                data: [pagosCEBA?.pagos_deposito],
                color: '#d4ac0d'
            },
            {
                name: 'OTROS',
                data: [pagosCEBA?.pagos_otros],
                color: '#b03a2e'
            },
        ]
    }
